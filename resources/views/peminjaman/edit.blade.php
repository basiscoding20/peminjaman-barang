            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <input type="hidden" name="users_id" id="users_id" value="{{ $peminjaman->users->id }}">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card-body">  
                                        <div class="form-group">
                                            <label for="users_id">Nama Peminjam</label>
                                            <input type="text" class="form-control" name="users_id" id="users_id" value="{{ $peminjaman->users->name }}" disabled>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="penanggung_jawab">Jumlah</label>
                                            <input type="text" class="form-control" name="penanggung_jawab" id="penanggung_jawab" value="{{ $peminjaman->penanggung_jawab ?? old('penanggung_jawab') }}">
                                            <p class="text-danger">{{ $errors->first('penanggung_jawab') }}</p>
                                        </div>
